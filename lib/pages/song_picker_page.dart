    ...
    return showDialog<String>(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setStateDialog) => AlertDialog(
          ...
          title: Text(esUnaSola ? 'Exportar PDF' : 'Nombre del repertorio'),
          content: Column(
            ...
            children: [
              ...
              const Text('Tamaño de letra', style: TextStyle(fontWeight: FontWeight.w600)),
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                _fontSize = fontSize; // guardar para la próxima vez
                Navigator.pop(context, _tituloController.text.trim());
              },
